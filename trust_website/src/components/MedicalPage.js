    ...
    <div className="medical_body">
      ...
      <div className="medical_section_2">
        ...
        <div className="medical_objective_content">
          As a recognition of Mrs. Srinivasan unflinching kindness particularly
          towards those who suffered chronic and life- threating illnesses, this
          fund’s aim is to help people with acute life- threatening health
          issues.
        </div>
      </div>
    </div>
